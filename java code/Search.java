...
public class Search {
    ...
    public static String findDocTitle(int id) throws IOException {
    ...
    public static String findDoc(int id) throws IOException {
        String indexLocation = "med";
        // 1. open the index
        Directory index = FSDirectory.open(new File(indexLocation));
        IndexReader reader = IndexReader.open(index);
    ...
    public static ArrayList<String> findSynonyms(String query, int k) {
    ...
    public static String search(String query, boolean expand, int k, int start) {
        String output = "";
        ...
        try {
            ...
            if (!expand) {
                ...
                //expand query
                ArrayList<String> synonyms = findSynonyms(query, k);
